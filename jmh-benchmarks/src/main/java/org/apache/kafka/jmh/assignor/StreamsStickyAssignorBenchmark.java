...
public class StreamsStickyAssignorBenchmark {
    ...
    @Setup(Level.Trial)
    public void setup() {
        List<String> allTopicNames = AssignorBenchmarkUtils.createTopicNames(topicCount);
    ...
    private void simulateIncrementalRebalance() {
        ...
        for (String memberId : groupSpec.members().keySet()) {
            ...
            updatedMemberSpec.put(memberId, new AssignmentMemberSpec(
                Optional.empty(),
                Optional.empty(),
