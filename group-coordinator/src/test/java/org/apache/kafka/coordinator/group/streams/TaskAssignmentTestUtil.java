...
public class TaskAssignmentTestUtil {
    ...
    @SafeVarargs
    public static TasksTupleWithEpochs mkTasksTupleWithEpochs(TaskRole taskRole, int defaultAssignmentEpoch, Map.Entry<String, Set<Integer>>... entries) {
        return switch (taskRole) {
            case ACTIVE -> new TasksTupleWithEpochs(mkTasksWithEpochsPerSubtopology(defaultAssignmentEpoch, entries), new HashMap<>(), new HashMap<>());
    ...
    public static Map.Entry<String, Map<Integer, Integer>> mkTasksWithEpoch(String subtopologyId,
    ...
    @SafeVarargs
    public static Map<String, Map<Integer, Integer>> mkTasksWithEpochsPerSubtopology(int defaultAssignmentEpoch, Map.Entry<String, Set<Integer>>... entries) {
